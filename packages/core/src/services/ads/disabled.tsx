...
export const isAdsEnabled: (config: CoreConfig) => boolean = () => false
export const isAnyAdFormatEnabled: (config: CoreConfig) => boolean = () => false
export const isBannerAdsEnabled: (config: CoreConfig) => boolean = () => false
export const isInterstitialAdsEnabled: (config: CoreConfig) => boolean = () => false
