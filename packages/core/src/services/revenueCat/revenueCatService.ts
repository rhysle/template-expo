...
const resolveRevenueCatApiKey = (appConfig: CoreConfig): string => {
  if (__DEV__) {
...
export const initRevenueCat = (appConfig: CoreConfig, appUserID?: string): void => {
  if (__DEV__) {
    void Purchases.setLogLevel(LOG_LEVEL.DEBUG)
  }

  Purchases.configure({ apiKey: resolveRevenueCatApiKey(appConfig), appUserID })
}
...
export const purchasePackage = async (
  ...
  try {
    ...
    return checkEntitlement(appConfig, customerInfo)
...
export const restorePurchases = async (
  ...
  return { success: checkEntitlement(appConfig, customerInfo), customerInfo }
}

export const checkEntitlement = (appConfig: CoreConfig, customerInfo: CustomerInfo): boolean => {
  return typeof customerInfo.entitlements.active[appConfig.revenueCat.entitlementId] !== 'undefined'
}

export const getActiveEntitlementId = (
  appConfig: CoreConfig,
  customerInfo: CustomerInfo
): string | null => {
