...
import { BaseComponentGallery } from './BaseComponentGallery'
import {
  clearAllStorage,
...
export const DebugScreen = ({
  ...
  const readDebugData = () => {
    const sliceVersions = getSliceVersionInfo(sliceModules)
    const storageEntries = getAllStorageEntries()
    const liveState = getLiveZustandState(store)
