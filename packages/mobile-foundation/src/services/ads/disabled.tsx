...
export const isAdsEnabled: (config: FoundationConfig) => boolean = () => false
export const isAnyAdFormatEnabled: (config: FoundationConfig) => boolean = () => false
export const isBannerAdsEnabled: (config: FoundationConfig) => boolean = () => false
export const isInterstitialAdsEnabled: (config: FoundationConfig) => boolean = () => false
