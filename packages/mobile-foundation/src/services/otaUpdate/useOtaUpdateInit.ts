...
import { AnalyticsGeneralEvents } from '@rhysle/mobile-foundation/services/firebase/analytics/analyticsGeneralEvents'
import { recordError, setSentryTag } from '@rhysle/mobile-foundation/services/sentry'
import { useOtaUpdateState } from '@rhysle/mobile-foundation/stores/features/otaUpdate'
...
export const useOtaUpdateInit = () => {
  ...
  }, [appConfig.otaUpdate.enabled, setLastAppliedUpdateId])
  ...
  }, [appConfig.otaUpdate.enabled, showSnackbar, t])
}
