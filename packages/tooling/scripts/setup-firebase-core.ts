...
export const getFirebaseAppIdentity = (appJson: JsonObject): FirebaseAppIdentity => {
  ...
  if (typeof eas.projectId !== 'string' || !eas.projectId.trim()) {
    throw new Error('Run pnpm setup:expo first; expo.extra.eas.projectId is missing.')
  }
  ...
  if (
    ...
    throw new Error('Run pnpm setup:expo first; expo.extra.eas.projectId is not a valid UUID.')
  }
