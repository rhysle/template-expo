 ...
 *
 * Usage:
 *   pnpm exec tsx scripts/check-i18n.ts
 *   pnpm exec tsx scripts/check-i18n.ts --remove-unused   # auto-remove unused keys from en.json
 *   pnpm exec tsx scripts/check-i18n.ts --release         # validate every locale before release
 *   pnpm exec tsx scripts/check-i18n.ts --release --remove-unused # remove obsolete release-locale keys
 */
