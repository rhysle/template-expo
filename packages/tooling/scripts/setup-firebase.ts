 ...
 *
 * Prerequisite: run pnpm setup:expo, authenticate personal Google ADC, and
...
const validateResolvedExpoConfigs = (): void => {
  ...
  delete baseEnvironment.APP_VARIANT
  delete baseEnvironment.GOOGLE_SERVICES_JSON
  delete baseEnvironment.GOOGLE_SERVICE_INFO_PLIST
...
const main = async (): Promise<void> => {
  ...
  console.log('Run pnpm prebuild:clean before the next native build.')
}
