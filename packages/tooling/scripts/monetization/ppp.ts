...
const NO_DATA_COUNTRIES: Readonly<Record<string, { iso3: string; countryName: string }>> = {
...
export const validateMoneyPrecision = (money: GoogleMoney): void => {
  ...
  if (digits === undefined) throw new Error('Currency fraction digits were not provided by Intl')
