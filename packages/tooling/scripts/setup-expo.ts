...
const CONFIG_FILES = ['package.json', 'app.json'] as const
...
async function main(): Promise<void> {
  ...
  try {
    ...
    try {
      applyAppIdentity(packageJson, appJson, identity)
      ...
      console.log('  pnpm prebuild:clean')
      console.log('  pnpm ios   # and/or pnpm android')
    } catch (error) {
