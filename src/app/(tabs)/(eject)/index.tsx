...
const EJECT_MASCOT_EFFECT = require('@/assets/animations/mascot/eject-spout.json')
const EJECT_MASCOT_SCALE = 1.2
      ...
      <View style={styles.primaryInteraction}>
        <View style={styles.heroSlot}>
          <MascotHero
            ...
            contentScale={EJECT_MASCOT_SCALE}
            effectSource={isActive ? EJECT_MASCOT_EFFECT : undefined}
            fillAvailableSpace
            showWaves={false}
          />
        </View>
