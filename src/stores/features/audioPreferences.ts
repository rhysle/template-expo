...
import type { EjectRoutineId, ToneWaveform } from '@/services/audio'
...
export const createAudioPreferencesSlice = (
  ...
  setEjectRoutineId: (routineId) =>
    set((state) => {
      state.ejectRoutineId = routineId
    }),
...
export const useAudioPreferencesState = () =>
  getUseAppStore()(
    useShallow(({ audioPreferences }) => ({
      ...
      ejectRoutineId: audioPreferences.ejectRoutineId,
      ...
      setEjectRoutineId: audioPreferences.setEjectRoutineId,
