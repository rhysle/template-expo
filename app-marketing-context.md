...
- **App ID (Apple):** 6799632468
- **App ID (Google Play):** com.rhysle.speakercleaner
- **Category:** Utilities
- **Secondary Category:** Music
- **Platform:** iOS and Android
- **Price Model:** Freemium with ads and Premium subscriptions/lifetime access
- **Launch Date:** Not yet publicly listed in the checked US Apple or Google storefront as of 2026-08-12
...
- **Subtitle:** Clear Wave, Liquid Remover
- **Keyword Field:** `clean,phone,stereo,test,frequency,hertz,audio,sound,noise,decibel,dust,debris,moisture`
- **Rating:** Not yet publicly listed in the checked US Apple or Google storefront
- **Primary Keywords:** No first-party rankings available before launch

## Goals

1. Establish launch relevance for “water eject” and “speaker cleaner” in every supported storefront.
2. Expand qualified discovery through tone generator, stereo test, sound meter, frequency, and local-language equivalents.
3. Improve conversion with specific feature benefits, privacy assurances, and accurate safety limitations.

## Resources

- **Budget:** Not specified; metadata work assumes organic launch optimization without paid keyword-volume tooling.
- **Team:** Small product team.
- **Tools:** Fastlane metadata, Firebase Analytics, RevenueCat, Sentry, and Apple/Google public storefront research.
- **Constraints:** No live first-party ranking history; no proprietary search-volume or difficulty data; app claims must remain consistent with the implemented, non-calibrated audio tools.
